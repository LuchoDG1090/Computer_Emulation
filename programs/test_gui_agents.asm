...
LD R1, var_A
LD R2, var_B
MOVI R3, str_channel_1
CALL __AGENT_LINK

# Link A -> C
LD R1, var_A
LD R2, var_C
MOVI R3, str_channel_2
CALL __AGENT_LINK

# Link B -> C
LD R1, var_B
LD R2, var_C
MOVI R3, str_channel_3
CALL __AGENT_LINK

# Send Message
MOVI R1, str_msg_type_4
MOVI R2, 0
LD R3, var_A
LD R4, var_B
CALL __AGENT_SEND
...
var_B: DW 0
var_C: DW 0
str_channel_1: DB "channel1", 0
str_channel_2: DB "channel2", 0
str_channel_3: DB "channel3", 0
str_msg_type_4: DB "INFO", 0
